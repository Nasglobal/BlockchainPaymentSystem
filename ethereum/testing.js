...
const contractAddress = '0x3c7f00a323df42407ebd9060e5ea80f791175301';
const privatekey1 = Buffer.from(privatekey11,'hex');
const privatekey2 = Buffer.from(privatekey22,'hex');
//var count = web3.eth.getTransactionCount(acc1);
var abi = [
	{
		"constant": true,
		"inputs": [],
...
try{
const ff = contract.methods.balanceOf(acc2).call();
